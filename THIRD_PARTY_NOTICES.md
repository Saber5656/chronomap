...
| Wikipedia / Wikimedia | Wikipedia text: CC BY-SA | https://www.mediawiki.org/wiki/Extension:GeoData | Article extracts are credited to Wikipedia and must link back to the source article; Wikimedia API behavior and attribution are tracked in `docs/research/wikimedia-geodata-api.md`. |
